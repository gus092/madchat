...
public class ChatActivity extends AppCompatActivity {
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        send_button = findViewById(R.id.send_button2);

        final EditText chat_text = (EditText) findViewById(R.id.chating_text2);
        ...
        new JsonGetAllTexts().execute("http://13.125.248.159:8080/api/texts");
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                try{
                    try{new JsonGetAllTexts().execute("http://13.125.248.159:8080/api/texts").get();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    if(tempar.length() > 40){
                        new JsonDeleteText().execute("http://13.125.248.159:8080/api/texts");
